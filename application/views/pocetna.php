...
<div class="full">
  ...
  <div class="space"></div>
<div class="subtitle">
  <div align="center"><span class="title">This Months Top  Kodi Builds</span><br />
...
<div class="contentbox">
  <div class="fifth">
    <p align="center"><strong>Most Downloads</strong> </p>
    <?php 
    $i=1;
    foreach($md as $broj=>$niz)
    {
      printf('<p align="center"><img src="../../%s/%s/icon.png" width="50" height="50" alt="Kodi Build" /><br />%s. %s</p>',$niz['username'],$niz['title'],$i,$niz['title']);
      $i++;
    }
    ?>
  </div>
  <div class="fifth">
    <p align="center"><strong>Most Popular</strong> </p>
    <?php 
    $i=1;
    foreach($mp as $broj=>$niz)
    {
      printf('<p align="center"><img src="../../%s/%s/icon.png" width="50" height="50" alt="Kodi Build" /><br />%s. %s</p>',$niz['username'],$niz['title'],$i,$niz['title']);
      $i++;
    }
  ...
  <div class="fifth">
    <p align="center"><strong>Smallest Build </strong></p>
    <?php 
    $i=1;
    foreach($sb as $broj=>$niz)
    {
      printf('<p align="center"><img src="../../%s/%s/icon.png" width="50" height="50" alt="Kodi Build" /><br />%s. %s</p>',$niz['username'],$niz['title'],$i,$niz['title']);
      $i++;
    }
  ...
  <div class="fifth">
    <p align="center"><strong>Recently Updated</strong> </p>
    <?php 
    $i=1;
    foreach($mu as $broj=>$niz)
    {
      printf('<p align="center"><img src="../../%s/%s/icon.png" width="50" height="50" alt="Kodi Build" /><br />%s. %s</p>',$niz['username'],$niz['title'],$i,$niz['title']);
      $i++;
    }
  ...
  <div class="fifth">
    <p align="center"><strong>Newest Builds</strong></p>
    <?php 
    $i=1;
    foreach($nb as $broj=>$niz)
    {
      printf('<p align="center"><img src="../../%s/%s/icon.png" width="50" height="50" alt="Kodi Build" /><br />%s. %s</p>',$niz['username'],$niz['title'],$i,$niz['title']);
      $i++;
    }
  ...
  <div class="fifty">
    <blockquote>
      ...
      <p><span class="steps">Step 3</span><br />
        <span class="substeps">Upload your Kodi build zip file to our servers and we give you a share link to use in your Kodi Wizard Addon or <a href="http://www.lodi.mobi">Lodi APK</a>. </span></p>
    </blockquote>
    </div>
</div>
<div class="space"></div>
<div class="header">
  <div align="center" class="title">
    <p>We are better than any other alternative</p>
    <h6 class="whitesub">100% FREE - NO DOWNLOAD LIMITS - FULL SPEEDS -
DIRECT DOWNLOAD LINKS - DOWNLOAD STATS</h6>
  </div>
</div>
<div class="contentbox">
  <div class="quarter">
    <h2 align="center"><strong>Rapid Share</strong></h2>
    <p align="center"><img src="<?php echo base_url();?>/images/rapidshare.png" width="150" height="100" alt="rapidshare" /></p>
    <p align="center">Slow download speeds<br />
      No download stats
    </p>
  </div>
  <div class="quarter">
    <h2 align="center"><strong>Dropbox</strong></h2>
    <p align="center"><img src="<?php echo base_url();?>/images/dropbox.png" width="150" height="100" alt="Dropbox" /></p>
    <p align="center">Daily download limits<br />
      No download stats
    </p>
  </div>
  <div class="quarter">
    <h2 align="center"><strong>Webserver</strong></h2>
    <p align="center"><img src="<?php echo base_url();?>/images/webserver.png" width="150" height="100" alt="web server" /></p>
    <p align="center">Costs money<br />
      No download stats    </p>
  </div>
  <div class="quarter">
    <h2 align="center"><strong>Google Drive</strong></h2>
    <p align="center"><img src="<?php echo base_url();?>/images/googledrive.png" width="150" height="100" alt="google drive" /></p>
    <p align="center">Doesn't allow download links<br />
      No download stats    </p>
  </div>
</div>
<div class="space"></div>
<div class="contentbox">
  <div align="center">
    <p class="substeps">Once uploaded your build will be available to download via <a href="https://www.avstream.tv"><strong><br />
      ...
      from numerous apps using the KodiHub API including <a href="http://www.aerialview.tv/mobile/apps/"><strong>Appy</strong></a>.<br />
    Giving your build exposure to over 200,000 users worldwide!</p>
    <p class="tiny"><a href="<?php echo base_url(); ?>lodihub/complaint">File copyright takedown notice</a></p>
  </div>
</div>
<div class="space"></div>
<p>&nbsp;</p>
